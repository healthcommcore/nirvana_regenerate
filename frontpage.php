...
function nirvana_frontpage_generator() {
	...
	<div id="frontpage">
		...
		if ($nirvana_fronttext1 || $nirvana_fronttext3) { ?><div id="pp-texttop"><div class="container"><div class="home-padding"><?php
		...
		if ($nirvana_fronttext2 || $nirvana_fronttext4) {?><div id="pp-textmiddle"><div class="container"><div class="home-padding"><?php
		...
		if ($nirvana_fronttext5 || $nirvana_fronttext6) { ?><div id="pp-textbottom"><div class="container"><div class="home-padding"><?php
    ...
    <?php if( is_active_sidebar('homepage-bottom-widget') ) : ?>
    <div class="homepage-bottom-widget">
      <div class="container">
        <div class="home-padding">
          <?php dynamic_sidebar('homepage-bottom-widget'); ?>
        </div>
      </div>
    </div>
    <?php endif; ?>
	...
	switch ($nirvana_columnType) {
		...
		case 'Widget Columns':
			if (is_active_sidebar('presentation-page-columns-area')) {
				// if widgets loaded
				echo '<div id="front-columns-box"><div class="container"><div class="home-padding"><div id="front-columns" class="ppbox">';
